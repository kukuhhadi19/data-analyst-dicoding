...
[E-Commerce Data Dashboard Streamlit App]([https://e-commerce-data-analyst.streamlit.app/](https://data-analyst-dicoding.streamlit.app/))
...
```
git clone (https://github.com/kukuhhadi19/data-analyst-dicoding.git) 
```
...
## Data Sources
The project uses E-Commerce Public Dataset from [data-analyst-dicoding-main](https://drive.google.com/file/d/1t4oNDjYxnnth0o4K0lIJ7wSTBDla-kHw/view?usp=drive_link) offered by [Dicoding](https://www.dicoding.com/).
